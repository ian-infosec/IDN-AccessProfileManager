...
namespace Access_Profile_Manager
{
    ...
    {
        IDN_Helper_Authentication authentication = new IDN_Helper_Authentication("client_credentials", ConfigurationManager.AppSettings["ClientID"].ToString(), ConfigurationManager.AppSettings["ClientSecret"].ToString(), ConfigurationManager.AppSettings["OrgName"].ToString());
